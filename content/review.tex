...
\subsubsection{Describe the differences in earth-quake magnitudes between the
three types of plate boundaries and explain why these differences occur.}

Divergent: rather small (4-6.5 on Richter scale) because they are shallow.

Convergent: can be very strong (up to 9.5) because they can occur very deep,
up to 670km deep, thick crust subducting and bending releases a lot of energy.

Transform faults: quite shallow, but much stronger if they happen with
continental crust (up to 8.5) than with oceanic crust (up to 7.0).

\subsubsection{What are the differences between a mid-ocean ridge and a
hotspot?}

A mid-ocean ridge is a feature at the plates boundary and a hotspot is an
intraplate feature. A hot fume that detaches from the deep mantle pushes
through the asthenosphere and litosphere.

\subsubsection{Examine Figures 2.31 and 2.33. In which ocean basin would you
expect to find the oldest sea floor? Explain your reasoning.}

In the Pacific Ocean because it is in the declining phase and the continents
from both sides of it are converging.
...
\subsubsection{Discuss the origin of the various volcanic peaks of the abyssal
plains: seamounts, tablemounts, and abyssal hills.}

Seamounts are tall volcanoes formed at volcanic centers such as the mid-ocean
ridge.

If seamounts are tall enough to reach the surface and become islands, their
tops are eroded flat by wave activity and become tablemounts.

Abyssal hills are volcanic features smaller than 1000 meters on the ocean floor
and are created by stretchin of crust during the creation of new sea floor
at the mid-ocean ridge.

\subsubsection{What are some differences between a submarine canyon and an
ocean trench?}

Ocean trenches are created at active margins. They are deep linear scars in
the ocean floor (parallel to the coast, and submarine canyons are rather
perpendicular).

Submarine canyon can't get deeper than the ocean basin, and trenches are some
of the deepest points on Earth.
...
\subsubsection{Why is most lithogenous sediment composed of quartz grains?
What is the chemical composition of quartz?}

Quartz is composed of silicon and oxygen in the form of SiO$_2$. Quartz is a
major component of most rocks. It's one of the most abundant, chemically stable
and durable minerals in Earth's crust.

Thus it can be transported over long distances after chemical or physical
weathering of rocks.

\subsubsection{Explain the stages of progression that result in calcacerous
ooze existing below the CCD.}

\begin{enumerate}
	\item Calcareous ooze is deposited on the mid-ocean ridge above the
		CCD.
	\item Calcareous ooze is covered and protected by other sediments.
	\item Sea floor spreading moves calcareous ooze beneath the CCD into
		deep water.
\end{enumerate}
