...
\section{Chapter 7: Ocean circulation}

\subsection{Glossary of terms}
\begin{itemize}
	\item \textbf{surface currents} --
	\item \textbf{deep currents} --
	\item \textbf{gyres} --
	\item \textbf{subtropical gyres} --
	\item \textbf{equatorial currents} --
	\item \textbf{western boundary currents} --
	\item \textbf{northern boundary currents} --
	\item \textbf{southern boundary currents} --
	\item \textbf{eastern boundary currents} --
	\item \textbf{equatorial countercurrent} --
	\item \textbf{subpolar gyres} --
	\item \textbf{Ekman transport} --
	\item \textbf{Subtropical convergence} --
	\item \textbf{geostrophic current} --
	\item \textbf{western intensification} --
	\item \textbf{upwelling} --
	\item \textbf{downwelling} --
	\item \textbf{productivity} --
	\item \textbf{equatorial upwelling} --
	\item \textbf{coastal upwelling} --
	\item \textbf{coastal downwelling} --
	\item \textbf{monsoon} --
	\item \textbf{El Nino} --
	\item \textbf{La Nina} --
	\item \textbf{ENSO (El Nino-Southern Oscillation)} --
	\item \textbf{thermohaline circulation} --
\end{itemize}
